...
function Card({ name, image, id, price, type }) {
  ...
  return (
    <div className="w-[260px] h-[350px] bg-white p-3 rounded-xl shadow-md hover:shadow-lg transition-transform transform hover:scale-105 border border-gray-200 flex flex-col gap-2">
      ...
      <div className="text-xl font-semibold px-2 text-gray-800 truncate">
        {name}
      </div>
      ...
      <button
        className="p-3  w-full text-white bg-green-500 rounded-lg hover:bg-green-600 active:scale-95 transition-all duration-150 shadow-sm"
        onClick={() => {
          dispatch(
